    ...
    <div className="flex items-center gap-2 md:gap-3">
      ...
      <div className="relative flex-1">
        <button
          ...
          className="w-full px-3 py-2 md:px-4 md:py-2 bg-white border-2 border-gray-300 rounded-lg flex items-center gap-2 hover:border-purple-400 hover:shadow-md transition-all"
        >
        ...
        {/* Выпадающее меню */}
        {isOpen && (
          <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-lg border-2 border-gray-300 shadow-lg z-[9999] overflow-hidden">
      ...
      <div className="hidden md:block">
        <button
          ...
          className="px-4 py-2 bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-lg flex items-center gap-2 hover:border-green-400 hover:shadow-md transition-all"
        >
